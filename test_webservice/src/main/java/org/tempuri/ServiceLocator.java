...
public class ServiceLocator extends org.apache.axis.client.Service implements org.tempuri.Service {
    ...
    private java.lang.String BasicHttpBinding_IService_address = "http://192.168.5.184:8045/Service.svc";
    ...
    public org.tempuri.IService getBasicHttpBinding_IService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.BasicHttpBinding_IServiceStub _stub = new org.tempuri.BasicHttpBinding_IServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.IService.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.BasicHttpBinding_IServiceStub _stub = new org.tempuri.BasicHttpBinding_IServiceStub(new java.net.URL(BasicHttpBinding_IService_address), this);
                _stub.setPortName(getBasicHttpBinding_IServiceWSDDServiceName());
                return _stub;
            }
        }
