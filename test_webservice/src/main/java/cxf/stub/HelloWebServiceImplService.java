...
@WebServiceClient(name = "HelloWebServiceImplService", 
                  wsdlLocation = "http://localhost:8080/test_webservice/services/HelloWebService?wsdl",
                  targetNamespace = "http://server.cxf/") 
public class HelloWebServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.cxf/", "HelloWebServiceImplService");
    public final static QName HelloWebServiceImplPort = new QName("http://server.cxf/", "HelloWebServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/test_webservice/services/HelloWebService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWebServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/test_webservice/services/HelloWebService?wsdl");
        }
        WSDL_LOCATION = url;
    }
