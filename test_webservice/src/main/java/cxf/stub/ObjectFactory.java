 ...
 * generated in the cxf.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayResponse_QNAME = new QName("http://server.cxf/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://server.cxf/", "say");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cxf.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf/", name = "say")
