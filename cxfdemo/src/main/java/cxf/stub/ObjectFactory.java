...
public class ObjectFactory {
    ...
    private final static QName _SayResponse_QNAME = new QName("http://test.com/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://test.com/", "say");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "say")
